...
namespace Vehicles.API.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MyProperty,Description")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MyProperty,Description")] VehicleType vehicleType)
        {
